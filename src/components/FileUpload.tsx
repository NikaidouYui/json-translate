...
export function FileUpload({ dict }: FileUploadProps) {
  ...
  const { setFile, apiKey, setApiKey, baseUri, setbaseUri, modelName, setmodelName, resetTranslation } = useTranslate()
  ...
  return (
    <div className="w-full max-w-xl space-y-4">
      ...
      <ModelSelect apiKeyTip={dict.apiKeyTip}
      apiKeyTitle={dict.apiKeyTitle}
      apiKeyPlaceholder={dict.apiKeyPlaceholder} />
